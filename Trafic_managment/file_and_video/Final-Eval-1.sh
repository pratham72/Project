...
iptables -A FORWARD -p tcp --dport 3306 -m limit --limit 10/min -j LOG --log-prefix "DROPPED-MYSQL"
...
iptables -A FORWARD -p tcp --dport 21 -m limit --limit 10/min -j LOG --log-prefix "DROPPED-APACHE"
...
iptables -A FORWARD -p tcp --sport 22 -m limit --limit 10/min -j LOG --log-prefix "DROPPED-SSH"
